...
export const Navigation = () => {
    ...
    const handleCreate = () => {
        ...
        .then((documentId) => router.push(`/home/${documentId}`))
    ...
    return (
        <>
            ...
            <div ref={navbarRef} className={cn("absolute top-0 z-[99999] left-60 w-[calc(100%-240px)]", isResetting && "trnsition-all ease-in-out duration-300", isMobile && "left-0 w-full")}>
                {!!params.documentId ? (
